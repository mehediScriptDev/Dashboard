  ...
  return (
    <div className="min-h-screen bgColorPrimary p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col xl:flex-row gap-4 sm:gap-6">
        <div className="bg-stat-bg rounded-xl border border-border overflow-hidden xl:w-[40%] lg:h-fit">
          ...
          <div className="divide-y divide-border  lg:max-h-none overflow-y-auto">
            {callsData.map((call) => (
              <div
                ...
                className={`p-4 cursor-pointer  transition-colors ${selectedCall?.id === call.id ? 'border-b-2 border-[#2B7FFF]' : ''}`}
              >
        ...
        <div className="bg-stat-bg rounded-xl border border-border overflow-hidden xl:w-[60%]">
          <div className="p-4 border-b border-border">
